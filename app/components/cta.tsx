...
export default function CTA({ text, ghost, primary, disabled, url }: ctaOptions) {
	return (
		<Link
			href={url!}
			className={cn(
				"px-3 py-1.5 rounded-lg bg-white/10 w-full md:w-max gap-4 flex flex-row items-center justify-between text-center uppercase text-white transition-color duration-300 ease-in-out -mx-1",
				ghost &&
