  ...
  return (
    <div
      className={cn(
        ...
        !modalVisible
          ? "animate-disappear opacity-100"
          : "animate-emerge opacity-0"
      )}
      onClick={handleClose}
    ...
    >
      <div
        className={cn(
          "text-foreground bg-background/90 backdrop-blur-2xl border-util-border animate-fade-up relative mx-4 flex max-h-[90vh] w-xl max-w-full transform flex-col overflow-y-auto min-h-96 rounded-xl border border-slate-200 pt-2 pr-2 shadow-xl p-3 md:p-4",
          modalVisible
            ? "animate-fade-up opacity-0"
            : "animate-fade-down opacity-100"
        )}
