      ...
      >
        ...
        <div className="flex flex-1 justify-end gap-2">
          ...
          <div className="flex items-center">
            ...
            >
              <button
                className="transition-background duration-150 ease-in-out p-3 md:p-4 [&>svg]:h-16 w-12 h-12 md:w-16 md:h-16 flex items-center justify-center hover:bg-[#00000008] rounded-lg cursor-pointer"
                onClick={toggleLang}
