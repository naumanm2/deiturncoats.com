	...
	return (
		<>
			<div className="relative w-full aspect-[9/16] md:aspect-[2/1]">
				...
				{/* Content */}
				<div className="relative z-10 w-max max-w-full m-auto px-4 md:px-12 flex uppercase flex-col items-center justify-center text-white h-full">
					<h1 className="pb-4 text-center leading-none">{heading}</h1>
					<strong className="pb-5">{subtitle}</strong>
					<div className="w-full max-w-96">
						{ctaLink && ctaText && <CTA ghost={true} text={ctaText} url={ctaLink} />}
					</div>
				</div>
			</div>
		</>
